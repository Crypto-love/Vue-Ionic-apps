...
export const Order = objectType({
  ...
  definition(t) {
    ...
    t.field('delivery_time', { type: 'Date' });
...
export const PaymentB2c = objectType({
  ...
  definition(t) {
    ...
    t.model.description();
    t.model.refunded_amount();
    t.model.payment_transaction_id();
  }
});
...
export const GroupBuyCheckout = objectType({
  ...
  definition(t) {
    t.nonNull.int('payment_status_id');
...
export const B2COrderListPagination = objectType({
  name: 'B2COrderListPagination',
  definition(t) {
    t.list.field('b2c_order_list', { type: 'B2COrderList' });
    t.int('total_rows');
    t.int('total_page');
  }
});
