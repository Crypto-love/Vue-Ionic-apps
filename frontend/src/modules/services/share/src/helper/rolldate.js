...
(function (global, factory) {
  ...
  var bscroll_min = createCommonjsModule(function (module, exports) {
     ...
     */ !(function (t, i) {
          ...
          return (function (t, i) {
            ...
            try {
              for (
                ...
                !(s = (r = h.next()).done) && (e.push(r.value), !i || e.length !== i);
                s = !0
              );
            } catch (t) {
              (o = !0), (n = t);
      ...
      var d = h('transform'),
        ...
        x = { touchstart: 1, touchmove: 1, touchend: 1, mousedown: 2, mousemove: 2, mouseup: 2 };
      function b(t) {
      ...
      function Y(t) {
        ...
        'mouseup' === t.type || 'mousecancel' === t.type
          ? (e = t)
          : ('touchend' !== t.type && 'touchcancel' !== t.type) || (e = t.changedTouches[0]);
        var s = {};
        e &&
          ((s.screenX = e.screenX || 0),
      ...
      function E(t, i, e, s, o, n, r) {
        var h = t - i,
          ...
          f = t + (a / l) * (h < 0 ? -1 : 1);
        return (
          u && c && (f = Math.round(f / c) * c),
          f < s
            ? ((f = n ? Math.max(s - n / 4, s - (n / d) * a) : s), (m = p))
            : o < f && ((f = n ? Math.min(o + n / 4, o + (n / d) * a) : o), (m = p)),
          { destination: Math.round(f), duration: m }
        );
      }
      function D() {}
      var k,
      ...
      function A(t, i) {
        (this.wrapper = 'string' == typeof t ? document.querySelector(t) : t),
          this.wrapper || I('Can not resolve the wrapper DOM.'),
          (this.scroller = this.wrapper.children[0]),
          this.scroller || I('The wrapper need at least one child element to be scroller.'),
          (this.scrollerStyle = this.scroller.style),
          this._init(i);
      }
      return (
        ((k = A).prototype._init = function (t) {
        ...
        (k.prototype._handleOptions = function (t) {
          (this.options = a({}, _, t)),
            ...
            (this.options.useTransform = this.options.useTransform && y),
        ...
        (k.prototype._handleDOMEvents = function (t) {
          ...
          t(window, 'orientationchange', this),
            ...
            g &&
              ...
              t(i, 'touchend', this)),
            t(this.scroller, S.transitionEnd, this);
        }),
          ...
          if ('function' == typeof Object.defineProperty) {
            ...
            Object.defineProperty(this, t, {
              ...
              set: function (t) {
                n = t;
                for (
                  var i = o.scroller.children.length ? o.scroller.children : [o.scroller],
                    e = n && !o.pulling ? 'none' : 'auto',
                    s = 0;
                  s < i.length;
                  s++
                )
        ...
        (k.prototype._initDOMObserver = function () {
          ...
          if ('undefined' != typeof MutationObserver) {
            ...
            t.observe(this.scroller, { attributes: !0, childList: !0, subtree: !0 }),
        ...
        (k.prototype.handleEvent = function (t) {
          switch (t.type) {
            ...
            case 'click':
              this.enabled &&
                !t._constructed &&
                (X(t.target, this.options.preventDefaultException) ||
        ...
        (k.prototype.refresh = function () {
          ...
          s
            ...
            (this.directionX = 0),
            (this.directionY = 0),
            (this.wrapperOffset = m(this.wrapper)),
        ...
        (P.prototype._move = function (t) {
          if (this.enabled && !this.destroyed && x[t.type] === this.initiated) {
            ...
            if (
              ...
              !1 !== m &&
                ((l = void 0 === m.top || m.top),
                (c = void 0 === m.bottom || m.bottom),
                (p = void 0 === m.left || m.left),
                (u = void 0 === m.right || m.right)),
                (h > this.minScrollX || h < this.maxScrollX) &&
                  (h =
                    (h > this.minScrollX && p) || (h < this.maxScrollX && u)
                      ? this.x + e / 3
                      : h > this.minScrollX
                      ? this.minScrollX
                      : this.maxScrollX),
              ...
              var d = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft,
                ...
                v = this.pointX - d,
                g = this.pointY - f;
              (v > document.documentElement.clientWidth - this.options.momentumLimitDistance ||
                v < this.options.momentumLimitDistance ||
                g < this.options.momentumLimitDistance ||
                g > document.documentElement.clientHeight - this.options.momentumLimitDistance) &&
                this._end(t);
            }
          }
        }),
          ...
          if (this.enabled && !this.destroyed && x[t.type] === this.initiated) {
            ...
            if (
              ...
              if (this._checkClick(t)) this.trigger('scrollCancel');
                ...
                this._translate(i, e), (this.endTime = T());
                ...
                if (
                  ...
                  if (
                    ...
                    (h > this.options.momentumLimitDistance || r > this.options.momentumLimitDistance)
                  ) {
                    var l = !1,
                      c = !1,
                      p = !1,
                    ...
                    !1 !== m &&
                      ...
                      (u = void 0 === m.right || m.right));
                    var d =
                        (-1 === this.directionX && p) || (1 === this.directionX && u) ? this.wrapperWidth : 0,
                      f =
                        (-1 === this.directionY && l) || (1 === this.directionY && c)
                          ? this.wrapperHeight
                          : 0,
                      v = this.hasHorizontalScroll
                        ? E(this.x, this.startX, n, this.maxScrollX, this.minScrollX, d, this.options)
                        : { destination: i, duration: 0 },
                      g = this.hasVerticalScroll
                        ? E(this.y, this.startY, n, this.maxScrollY, this.minScrollY, f, this.options)
                        : { destination: e, duration: 0 };
                    (i = v.destination),
                      (e = g.destination),
                      (a = Math.max(v.duration, g.duration)),
                  ...
                  if (this.options.snap) {
                    ...
                    (this.currentPage = w),
                      (a =
                        ...
                        Math.max(
                          Math.max(Math.min(Math.abs(i - w.x), 1e3), Math.min(Math.abs(e - w.y), 1e3)),
                          300
                        )),
                      (i = w.x),
                      (e = w.y),
                      (this.directionX = 0),
                      (this.directionY = 0),
                      (y = this.options.snap.easing || M.bounce);
                  }
        ...
        (P.prototype._checkClick = function (t) {
              ...
              var h = Math.abs(Math.round(this.y / this.itemHeight)),
                a = Math.round(
                  (this.pointY +
                    ...
                    { left: -(n.left + window.pageXOffset), top: -(n.top + window.pageYOffset) }).top -
                    this.wrapperHeight / 2) /
                    this.itemHeight
                );
              this.target = this.items[h + a];
            }
            return (
              this.scrollToElement(this.target, this.options.wheel.adjustTime || 400, !0, !0, M.swipe), !0
            );
          }
          if (r) return !1;
          ...
          if (l && this.lastClickTime) {
            var p = l.delay,
              u = void 0 === p ? 300 : p;
            T() - this.lastClickTime < u && ((c = !0), Y(t, 'dblclick'));
          }
          return (
            this.options.tap &&
              ((i = t),
            ...
            this.options.click && !X(t.target, this.options.preventDefaultException) && Y(t),
            (this.lastClickTime = c ? null : T()),
            !0
          );
        }),
        ...
        (P.prototype._transitionEnd = function (t) {
          t.target === this.scroller &&
            ...
            (!this.pulling || 1 === this.movingDirectionY) &&
              ...
              ((this.isInTransition = !1),
              3 !== this.options.probeType && this.trigger('scrollEnd', { x: this.x, y: this.y })));
        }),
        (P.prototype._translate = function (t, i, e) {
          if (
            ((function (t, i) {
              if (!t) throw new Error('[BScroll] ' + i);
            })(!c(t) && !c(i), 'Translate x or y is null or undefined.'),
            c(e) && (e = this.scale),
            this.options.useTransform
              ? (this.scrollerStyle[S.transform] =
                  'translate(' + t + 'px,' + i + 'px) scale(' + e + ')' + this.translateZ)
              : ((t = Math.round(t)),
                (i = Math.round(i)),
            ...
            for (
              var s = this.options.wheel.rotate, o = void 0 === s ? 25 : s, n = 0;
              n < this.items.length;
              n++
            ) {
              var r = o * (i / this.itemHeight + n);
              this.items[n].style[S.transform] = 'rotateX(' + r + 'deg)';
            }
          ...
          (this.isAnimating = !0),
            ...
            (function t() {
              ...
              var e = l((i = (i - f) / a)),
                ...
                n = (d - m) * e + m;
              c._translate(s, o, n),
                c.isAnimating && (c.animateTimer = H(t)),
                3 === c.options.probeType && c.trigger('scroll', { x: c.x, y: c.y });
            })();
        }),
        ...
        (P.prototype.scrollTo = function (t, i) {
          var e = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
            s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : M.bounce;
          (this.x !== t || this.y !== i) &&
            ((this.isInTransition = this.options.useTransition && 0 < e && (t !== this.x || i !== this.y)),
            !e || this.options.useTransition
              ? (this._transitionTimingFunction(s.style),
                ...
                e ||
                  (this.trigger('scroll', { x: t, y: i }),
                  (this._reflow = document.body.offsetHeight),
                  this.resetPosition(this.options.bounceTime, M.bounce) ||
                    this.trigger('scrollEnd', { x: t, y: i })),
                this.options.wheel &&
                  (i > this.minScrollY
        ...
        (P.prototype.resetPosition = function () {
          ...
          return (
            !this.hasVerticalScroll || n > this.minScrollY
              ? (o = this.minScrollY)
              : n < this.maxScrollY && (o = this.maxScrollY),
        ...
        (P.prototype.getComputedPosition = function () {
          ...
          return (
            (e = this.options.useTransform
              ? ((i = +((t = t[S.transform].split(')')[0].split(', '))[12] || t[4])), +(t[13] || t[5]))
              : ((i = +t.left.replace(/[^-\d.]/g, '')), +t.top.replace(/[^-\d.]/g, ''))),
            { x: i, y: e }
          );
        }),
        ...
        (O.prototype._initWheel = function () {
          ...
          t.wheelWrapperClass || (t.wheelWrapperClass = 'wheel-scroll'),
            ...
            void 0 === t.selectedIndex &&
              ((t.selectedIndex = 0), I('wheel option selectedIndex is required!'));
        }),
          ...
          if (this.enabled) {
            ...
            clearTimeout(this.mouseWheelTimer),
              (this.mouseWheelTimer = setTimeout(function () {
                i.options.snap || a || i.trigger('scrollEnd', { x: i.x, y: i.y }),
            ...
            if (this.options.snap)
              return (
                ...
                0 < l ? u-- : l < 0 && u++,
                0 < c ? m-- : c < 0 && m++,
                void this._goToPage(u, m)
              );
            (u = this.x + Math.round(this.hasHorizontalScroll ? l : 0)),
              (m = this.y + Math.round(this.hasVerticalScroll ? c : 0)),
              (this.movingDirectionX = this.directionX = 0 < l ? -1 : l < 0 ? 1 : 0),
              (this.movingDirectionY = this.directionY = 0 < c ? -1 : c < 0 ? 1 : 0),
              u > this.minScrollX ? (u = this.minScrollX) : u < this.maxScrollX && (u = this.maxScrollX),
              m > this.minScrollY ? (m = this.minScrollY) : m < this.maxScrollY && (m = this.maxScrollY);
            var d = this.y === m;
            this.scrollTo(u, m, a, M.swipe),
  ...
  Rolldate.prototype = {
    ...
    createUI: function createUI() {
      ...
      var _loop = function _loop(_i) {
        ...
        _this.scroll[FormatArr[_i]] = new bscroll_min('#' + $id, {
          wheel: { selectedIndex: 0, wheelWrapperClass: 'wheel-scroll', wheelItemClass: 'wheel-item' },
          probeType: 1
        });
        ...
        that.on('scrollEnd', function () {
          ...
          if ([domId['YYYY'], domId['MM']].indexOf(that.wrapper.id) != -1 && _this.scroll['DD']) {
            var prevDay = _this.getSelected(_this.scroll['DD']),
              _day = _this.bissextile(
                _this.getSelected(_this.scroll['YYYY']),
                _this.getSelected(_this.scroll['MM'])
              ),
              li = '';
    ...
    getSelected: function getSelected(scroll) {
      return this.$('#' + scroll.wrapper.id + ' li', 1)[scroll.getSelectedIndex()].innerText.replace(
        /\D/g,
        ''
      );
    }
