  ...
  <q-page padding>
    ...
    <div class="q-ma-md q-pa-md" style="border: 1px solid #dadce0; border-radius: 4px">
        ...
        >
          ...
          <div class="row">
            <div class="q-mr-md q-mb-md col-md-4 col-sm-6 col-xs-12">
              ...
              <q-input type="password" value="234234ds3" stack-label dense outlined lazy-rules disable />
            </div>
          </div>
          <div class="row">
            <div class="q-mr-md q-mb-md col-md-4 col-sm-6 col-xs-12">
      ...
      <q-dialog v-model="openChangePwd">
        <password-dialog :type="true" :id="id" @close="closePwd" @update="updatePwd"></password-dialog>
      </q-dialog>
    </div>
  </q-page>
</template>
...
import { getSupplierUserDetails, updateSupplierUser } from 'treeGQL';
  ...
  methods: {
    async getData() {
      ...
      this.formUserData = {
        ...
        mobile: this.personalDetails.mobile,
        ...
        buyer_type: this.personalDetails.buyer_type,
      ...
      this.splitPhoneAndCountryCode(this.formUserData.mobile);
      this.$q.loading.hide();
    },
          ...
          .mutate({
            ...
            variables: {
              jsonData: JSON.stringify({
                ...
                buyer_type: this.formUserData.buyer_type,
    ...
    gotoDetail() {
      this.$router.push({
        path: `/main/users/supplier_user/` + this.id + `/` + this.type
      });
    },
