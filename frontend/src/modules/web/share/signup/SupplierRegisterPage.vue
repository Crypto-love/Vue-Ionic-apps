      ...
      <q-form @submit="onSubmit" ref="loginForm">
        <div class="column items-left justify-center">
          <div class="text-dark q-mx-sm q-mb-lg">
            <div class="text-weight-bold q-py-sm" style="font-size: 32px">Join As Supplier</div>
            <div class="text-weight-regular" style="font-size: 16px">
              Let's Reduce Food Loss. Saving Costs. Improving Profits. And Save the Environment at the same
              time with TreeDots
            </div>
          </div>
