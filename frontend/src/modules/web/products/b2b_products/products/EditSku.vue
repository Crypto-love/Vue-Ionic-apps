              ...
              <div class="row">
                <div class="col-7">
                  <div class="q-gutter-lg">
                    ...
                    />
                    <q-toggle
                      v-model="formData.is_order_by_weight"
                      label="Can Order By Weight"
                      left-label
                      :true-value="1"
                      :false-value="0"
                    />
              ...
              <div class="row q-col-gutter-md">
                <div class="col-6">
                  <div class="q-gutter-md">
                    ...
                    />
                    <q-checkbox
                      v-model="isDefaultTaxRate"
                      dense
                      :label="`Use default tax rate (${item.tenant_tax_rate}%)`"
                      color="primary"
                      @input="(v, e) => (formData.tax_rate = 0)"
                    />
                    <q-input
                      v-if="!isDefaultTaxRate"
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 text-right" v-if="formData.b2c == 1 && formData.is_sample == 0">
                        <q-toggle
                    ...
                    <div class="row q-col-gutter-sm q-mt-sm">
                      <div class="col">
                        <div class="box-val">
                          ...
                          <div class="value text-primary">
                            {{ formData.currency_symbol }} {{ totalPrice.toFixed(4) }}
                          </div>
                        </div>
                      </div>
                      <div class="col" v-if="formData.is_sample == 0">
                        <div class="box-val">
                          ...
                          <div class="value text-primary">
                            {{ formData.currency_symbol }} {{ totalMarketUnitPrice.toFixed(4) }}
                          </div>
                        </div>
                      </div>
                      <div class="col" v-if="formData.is_sample == 0">
                ...
                <div class="col-6">
                  ...
                  <div class="row q-col-gutter-sm q-mt-sm">
                    <div class="col">
                      <div class="box-val">
                        <div class="label">Total Price</div>
                        <div class="value text-primary">${{ b2cTotalPrice.toFixed(4) }}</div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="box-val">
                        <div class="label">Market Price</div>
                        <div class="value text-primary">${{ b2cTotalMarketUnitPrice.toFixed(4) }}</div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="box-val">
          ...
          <q-step :name="3" title="SKU Preview" class="q-mb-xs" icon="eva-file-text-outline">
            <q-form id="stepThreeForm" @submit.prevent="onContinueClick">
              <div class="row q-col-gutter-lg">
                <div class="col-6">
                  <div class="prev-title">Preview SKU (B2B)</div>
                  <div class="row q-col-gutter-sm">
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Unit of Measurement</div>
                        <div class="value text-primary">{{ selectedUom.name }}</div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Ordering Measurement</div>
                        <div class="value text-primary">{{ selectedOom.name }}</div>
                      </div>
                    </div>
                  </div>
                  <div class="row q-col-gutter-sm q-mt-xs">
                    <div class="col-6">
                      <div class="box-val">
                        ...
                        <div class="value text-primary">
                          {{ formData.currency_symbol }} {{ formData.price }}
                        </div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Weight per {{ selectedOom.name }} (KG)</div>
                        <div class="value text-primary">{{ weightPerOom }}</div>
                      </div>
                    </div>
                  </div>
                  <div class="row q-col-gutter-sm q-mt-xs">
                    <div class="col-6">
                      <div class="box-val">
                        ...
                        <div class="value text-primary">
                          {{ formData.currency_symbol }} {{ formData.market_unit_price }}
                        </div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Number of {{ selectedUom.name }} per {{ selectedOom.name }}</div>
                        <div class="value text-primary">{{ formData.unit_per_oom }}</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <div class="box-val">
                        <div class="label">Total Price</div>
                        <div class="value text-primary">
                          {{ formData.currency_symbol }} {{ totalPrice.toFixed(2) }}
                        </div>
                      </div>
                    </div>
                    <div class="col" v-if="formData.is_sample == 0">
                ...
                <div class="col-6" v-if="formData.b2c == 1">
                  ...
                  <div class="row q-col-gutter-sm q-mt-xs">
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Unit Price</div>
                        <div class="value text-primary">${{ formData.b2c_unit_price }}</div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="box-val">
                  ...
                  <div class="row q-col-gutter-sm q-mt-xs">
                    <div class="col-6">
                      <div class="box-val">
                        <div class="label">Market Unit Price</div>
                        <div class="value text-primary">${{ formData.b2c_market_unit_price }}</div>
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="box-val">
                  ...
                  <div class="row q-gutter-sm">
                    <div class="col">
                      <div class="box-val">
                        <div class="label">Total Price</div>
                        <div class="value text-primary">${{ b2cTotalPrice.toFixed(2) }}</div>
                      </div>
                    </div>
                    <div class="col">
                      <div class="box-val">
    ...
    this.getData().then(() => {
      if (this.item) {
        this.formData = {
          ...
          is_order_by_weight: this.item.is_order_by_weight,
        ...
        this.isDefaultTaxRate = Number(this.item.tax_rate) === 0;
      }
    });
  },
