  ...
  >
    <q-form @submit.prevent="onSubmit" id="myForm">
      <div class="row q-col-gutter-x-md">
        ...
        <div class="col-xs-12 col-md-6" v-if="isInventoryTracking">
          <q-input
            v-model="formData.par_level"
            :disable="!isInventoryTracking"
            :label="`Par Level`"
            lazy-rules
            :rules="[(val) => (!isNaN(val) && val >= 0) || 'Number Only']"
    ...
    this.getData().then(() => {
      if (this.isEditMode) {
        ...
        this.formData = {
          ...
          par_level: rest.par_level || null,
          min_qty: rest.min_qty || null,
